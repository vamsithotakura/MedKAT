...
public class UIMAAnnotationUtils
{
    ...
    public static <T extends Annotation> T getSameOffsetAnnotation (JCas jcas, Class<T> ann_class, Annotation source)
    {
        return getSameOffsetAnnotation(jcas, ann_class, source.getBegin(), source.getEnd());
    }
    
    public static <T extends Annotation> List<T> getSameOffsetAnnotations (JCas jcas, Class<T> ann_class, Annotation source)
    ...
    static public FSIterator fsIterator (JCas jcas, Type type)
    throws IllegalArgumentException,
           SecurityException,
           IllegalAccessException,
           NoSuchFieldException,
    ...
    {
        AnnotationIndex ind = jcas.getJFSIndexRepository().getAnnotationIndex(UIMAAnnotationUtils.getTypeIndexId(type));
        
        return ind.iterator();
    }

    @SuppressWarnings("unchecked")
    public static <T extends Annotation> T getSameOffsetAnnotation (JCas jcas, Class<T> ann_class, int begin, int end)
    {
        try {
    ...
    @SuppressWarnings("unchecked")
    public static <T extends Annotation> List<T> getSameOffsetAnnotations (JCas jcas, Class<T> ann_class, int begin, int end)
    {
    ...
    @SuppressWarnings("unchecked")
    static public <T extends Annotation> Iterator<T> iterator (JCas jcas, Type type) 
    throws IllegalArgumentException,
           SecurityException,
           IllegalAccessException,
           NoSuchFieldException,
           ClassNotFoundException
    {
        return (Iterator<T>)fsIterator(jcas, type);
    }
