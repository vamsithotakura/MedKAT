 ...
 * @generated */
public class OriginTerm_Type extends Annotation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (OriginTerm_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = OriginTerm_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new OriginTerm(addr, OriginTerm_Type.this);
  			   OriginTerm_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new OriginTerm(addr, OriginTerm_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = OriginTerm.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.ohnlp.medkat.taes.conceptMapper.OriginTerm");
  ...
  public String getDictCanon(int addr) {
      ...
      jcas.throwFeatMissing("DictCanon", "org.ohnlp.medkat.taes.conceptMapper.OriginTerm");
  ...
  public String getSemClass(int addr) {
      ...
      jcas.throwFeatMissing("SemClass", "org.ohnlp.medkat.taes.conceptMapper.OriginTerm");
  ...
  public int getEnclosingSpan(int addr) {
      ...
      jcas.throwFeatMissing("enclosingSpan", "org.ohnlp.medkat.taes.conceptMapper.OriginTerm");
  ...
  public String getPOS(int addr) {
      ...
      jcas.throwFeatMissing("POS", "org.ohnlp.medkat.taes.conceptMapper.OriginTerm");
  ...
  public String getMatchedText(int addr) {
      ...
      jcas.throwFeatMissing("matchedText", "org.ohnlp.medkat.taes.conceptMapper.OriginTerm");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public OriginTerm_Type(JCas jcas, Type casType) {
    super(jcas, casType);
