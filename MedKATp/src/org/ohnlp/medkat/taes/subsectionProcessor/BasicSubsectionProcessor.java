...
public abstract class BasicSubsectionProcessor
...
implements TextAnnotator
{
     ...
     */
    private static final String PARAM_PRIMARY_SECTION_ANNOTATIONS = "SectionAnnotations";
    ...
    private static final String PARAM_ONLYPROCESSCONTENTSECTION = "OnlyProcessContentSection";
    private boolean onlyProcessContentSection;
    ...
    public void initialize (AnnotatorContext annotatorContext) throws AnnotatorInitializationException, AnnotatorConfigurationException
    {
        ...
        try
        {
            ...
            Boolean onlyProcessContentSectionObj = ((Boolean) getContext().getConfigParameterValue(PARAM_ONLYPROCESSCONTENTSECTION));
            if (onlyProcessContentSectionObj == null)
            {
                onlyProcessContentSection = false;
            }
            else
            {
                onlyProcessContentSection = onlyProcessContentSectionObj.booleanValue ();
            }
        }
        ...
        throws AnnotatorProcessException
    {
        ...
        try
        {
            ...
            processDocumentSections (tcas, jcas, primaryDocumentSectionAnnotationIndexes, subSectionIndex);
     ...
     */
    private void processDocumentSections (CAS tcas, JCas jcas, FSIndex [] documentSectionAnnotationIndexes, AnnotationIndex subSectionIndex)
    {
            ...
            while (docSectionIter.hasNext ())
            {
                ...
                while (subSectionIter.hasNext ())
                {
                    ...
                    if (onlyProcessContentSection)
                    {
                        ...
                        //}
                        processSubSection (tcas, jcas, subsection, subsection.getContentBegin(), subsection.getEnd());
                    }
                    else
                    {
                        //if ((getAnnotatorName () != null) && getAnnotatorName ().equalsIgnoreCase("LymphSelector"))
                        ...
                        //}
                        processSubSection (tcas, jcas, subsection, subsection.getBegin(), subsection.getEnd());
                    }
                }
            }
        }
     ...
     */
    protected abstract void processSubSection (CAS tcas, JCas jcas, SubHeading subsection, int begin, int end);
