...
package org.ohnlp.medkat.conceptMapper.support.tokenizer;
...
public class TokenAnnotation_Type extends uima.tt.TokenAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.ohnlp.medkat.conceptMapper.support.tokenizer.TokenAnnotation");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "org.ohnlp.medkat.conceptMapper.support.tokenizer.TokenAnnotation");
  ...
  public int getTokenType(int addr) {
      ...
      jcas.throwFeatMissing("tokenType", "org.ohnlp.medkat.conceptMapper.support.tokenizer.TokenAnnotation");
  ...
  public String getTokenClass(int addr) {
      ...
      jcas.throwFeatMissing("tokenClass", "org.ohnlp.medkat.conceptMapper.support.tokenizer.TokenAnnotation");
