 ...
 * 
 */
public class SentenceDetectorAnnotator extends JTextAnnotator_ImplBase
{
    ...
    private opennlp.tools.lang.english.SentenceDetector m_sentenceDetector;
            ...
            AnnotatorConfigurationException
    {
        ...
        try {
            m_sentenceDetector = new SentenceDetector(ctx.getConfigParameterValue(PARAM_MODELFILE).toString());
    ...
    throws AnnotatorProcessException
    {
        ...
        int sentenceOffsets[] = m_sentenceDetector.sentPosDetect(docText);
        int begin = 0;
        for (int i = 0; i < sentenceOffsets.length; i++) {
            Annotation sentence = (Annotation)jcas.getCas().createAnnotation(sentenceType, begin, sentenceOffsets[i]);
